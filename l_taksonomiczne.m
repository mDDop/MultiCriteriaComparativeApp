...
h = uibuttongroup('visible','on','BackGroundColor',kol2(5,:),...
    'Position',[320/wymiarx 480/wymiary 180/wymiarx 100/wymiary],'SelectionChangeFcn','wczytaj_dane7');
...
h3 = uibuttongroup('visible','on','BackGroundColor',kol2(5,:),...
    'Position',[540/wymiarx 480/wymiary 225/wymiarx 100/wymiary],'SelectionChangeFcn','wczytaj_dane7');
oo4(1)=uicontrol(gcf,'style','radiobutton','String','taksonomiczna miara rozwoju',...
...
if n>1
   ...
   set(w1122,'ColumnWidth',{53})
    w11123=uitable(gcf,'Data',DDDi(1:w411,wyznacznikZij),'ColumnName','Wynik',...
        'RowName',WWW(1:w411),'Position',[650 50 110 380]);
    set(w11123,'ColumnWidth',{60})
end
%-------------------------------------------------------------
